package archimedes.backend.crudjpa.util;
...
public class NameManager {
	...
	/**
	 * Returns the names provider for a DBO of the passed table.
	 * 
	 * @param table The table which the DBO name is to find for.
	 * @return The names provider for a DBO of the passed table.
	 */
	public NamesProvider getDBONamesProvider(TableSO table) {
		return new NamesProvider() //
				.setClassName(getClassName(table) + "DBO") //
				.setPackageName("persistence.dbo") //
		;
	}
